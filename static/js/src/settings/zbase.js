...
`);
    ...
    refresh_jwt_token(){
        setInterval(() => {
            $.ajax({
                url:"https://app5353.acapp.acwing.com.cn/settings/token/refresh/",
                type:"post",
                data:{
        ...
        setTimeout(() => {
            $.ajax({
                url:"https://app5353.acapp.acwing.com.cn/settings/ranklist/",
                type:"get",
                headers:{
    ...
    login_on_remote(username,password){ //在远程服务器上登录
        ...
        $.ajax({
            url:"https://app5353.acapp.acwing.com.cn/settings/token/",
            type:"post",
            data:{
                username:username,
                password:password,
    ...
    register_on_remote(){ //在远程服务器上注册
        ...
        $.ajax({
            url: "https://app5353.acapp.acwing.com.cn/settings/register/",
            type: "post",
            data: {
                username: username,
                password: password,
    ...
    getinfo_acapp() {
        ...
        $.ajax({
            url: "https://app5353.acapp.acwing.com.cn/settings/acwing/acapp/apply_code/",
            type: "GET",
            success: function(resp) {
                if (resp.result === "success") {
    ...
    getinfo_web(){
        $.ajax({
            url:"https://app5353.acapp.acwing.com.cn/settings/getinfo/",
            type:"GET",
            data:{
